...
#Modified from PA 3, Q3 to select these columns:
#(TUITIONFEE_IN),(TUITIONFEE_OUT),(ADM_RATE)
...
#Modified Challenge 4 left_join
ca_childcare <- childcare_costs |>
  right_join(
    y = counties |> 
      filter(state_abbreviation == "CA"),
...
#Inspired from Lab 4, Q8 (Used Kable package to bold table titles)
statewide_by_year |>
